...
public class HtmlWriter 
{
	...
	//************************ Caliculating the Execution time of the suit *********************	
		try
		{
	...
	// *******************************************************************************************	
		...
		try
		{
			...
			Element envi = root.getChild("Environment");
			...
			write.write("<html><head><title>Result Output</title>" +
					...
					"</br>User: "+envi.getAttributeValue("userName")+" on "+envi.getAttributeValue("os")+" "+envi.getAttributeValue("osVersion")+"</p></div>"+
					"</div>"+
					"<div id=\"menu\">"); 
...
// Writing Test scenarios to a table
